...
/*
frequency of given char from the given string, as int
 */
    ...
    /*
    returnes the unique characters for the given string
     */
    ...
    /*
    removes the duplicates from the string and ruturns it
     */
