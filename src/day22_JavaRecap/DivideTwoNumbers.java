...
public class DivideTwoNumbers {
    public static void main(String[] args) {
        ...
        int count = 0;//number of the times that we can substract b from a
...
4. write a program that can divide two numbers without using / & % operators and retuns the devision and remainder
            ex:
                ...
                As long as numerator is greater than or equa denominator,
                denominator can be keep substracted from numerator.
