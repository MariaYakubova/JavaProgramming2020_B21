...
// sort (array)
        int[] arr1 = {200000, 100000, 4000000, 6000, 30000, 1234567, 90000};
        Arrays.sort(arr1);// daes not return any value, cannot be assined to a variable nor pass it in print ststement
